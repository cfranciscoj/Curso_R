...
#R: Las observaciones corresponde al paÌs Kuwait y los aÒos corresponden a:
...
#            a√±os 1952 y 2007. Para ello usted deber√° replicar el siguiente
...
# hist(x=vida$lifeExp,freq = T,main = "Histograma de edad aÒo 1992",
...
#R: El paÌs con la mayor esperanza de vida fue JapÛn, alcanzando un valor de 79.4
...
#hipÛtesis nula, esto es que la variable en estudio tenga una distribuciÛn
#normal.
...
#sea superior a 54 aÒos es de 0.2634829.
...
#R: Mediante prueba y error, se garantiza que se gestiorarÌan 
...
#para el tramo I, ingresando a la tercera posiciÛn "Pastry", cuarta
#posiciÛn "Tea" y quinta posiciÛn "Medialuna".
#Para el tramo II y III sÛlo cambia la quinta posiciÛn,
